...
namespace WildFarming.Ecosystem.Config
{
    ...
    internal static class ConfigFieldOrder
    {
        ...
        static readonly string[] SpreadFields =
        {
            ...
            nameof(EcosystemConfig.FlowerPhenologyStressEnterDieback),
            nameof(EcosystemConfig.FlowerPhenologyStressExitDieback),
            nameof(EcosystemConfig.FlowerPhenologyColdStressGainPerDay),
            nameof(EcosystemConfig.FlowerPhenologyHeatStressGainPerDay),
            nameof(EcosystemConfig.FlowerPhenologySeasonExitStressGainPerDay),
            nameof(EcosystemConfig.FlowerPhenologyStressDecayPerDay),
            nameof(EcosystemConfig.MaxFlowerPhenologyLifeCycles),
        ...
        static readonly string[] TreeFields =
        {
            ...
            nameof(EcosystemConfig.TreeNicheLifespanStressGraceYears),
            nameof(EcosystemConfig.TreeNicheLifespanStressHardDebtPerYear),
            nameof(EcosystemConfig.TreeNicheLifespanStressSoftDebtPerYear),
            nameof(EcosystemConfig.TreeNicheLifespanStressRecoveryPerYear),
            nameof(EcosystemConfig.TreeNicheLifespanStressMaxDebtFraction),
            nameof(EcosystemConfig.TreeNicheLifespanStressSeralSoftThreshold),
