...
namespace WildFarming.Ecosystem
{
    ...
    internal static class WildAquaticEcology
    {
        public readonly struct Profile
        {
            ...
            /// <summary>Per reproduce attempt, chance to use distant seed/fragment dispersal instead of rhizome step.</summary>
        ...
        {
            ["coopersreed"] = new Profile(EcologyHabitat.ReedNearWater, 3, 23, 0.4f, 1f, 1.0f, 1, 0, 1, seedDispersalChance: 0.08f, seedDispersalRadius: 6),
            ["tule"] = new Profile(EcologyHabitat.ReedNearWater, 5, 25, 0.4f, 1f, 0.85f, 1, 0, 1, seedDispersalChance: 0.06f, seedDispersalRadius: 5),
