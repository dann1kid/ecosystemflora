...
- current repo stage: **Ecosystem v3.6.0** — see `docs/PROGRESS.md`, gaps — `docs/GAPS.md`; canopy — `docs/CANOPY_PHENOLOGY.md`, ambience — `docs/CANOPY_AMBIENCE.md`, tree lifecycle (spread → age → senescence → stump/logs) — `docs/TREE_AGING.md`; player changelog — `docs/CHANGELOG.md`;
...
- Tests: `tests/WildFarming.Tests.csproj` (xUnit, 260 tests).
