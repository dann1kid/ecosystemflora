...
- current repo stage: **Ecosystem v3.5.0** — see `docs/PROGRESS.md`, gaps — `docs/GAPS.md`; canopy — `docs/CANOPY_PHENOLOGY.md`, ambience — `docs/CANOPY_AMBIENCE.md`, tree maturation — `docs/TREE_AGING.md`;
...
- Tests: `tests/WildFarming.Tests.csproj` (xUnit, 242 tests).
