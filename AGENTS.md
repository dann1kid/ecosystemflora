...
- current repo stage: **Ecosystem v3.9.24** — Phase 6 — `docs/PHASE6_SIMULATION.md` (§6.2–§6.12); registration — `docs/BACKGROUND_REGISTRATION.md`; spread maturation — `docs/FLOWER_SPREAD_MATURATION.md`, `docs/TALLGRASS_SPREAD_MATURATION.md`; **flower phenology** — `docs/FLOWER_PHENOLOGY.md`; canopy — `docs/CANOPY_PHENOLOGY.md`, ambience — `docs/CANOPY_AMBIENCE.md`, tree lifecycle — `docs/TREE_AGING.md`, tree fern — `docs/FERNTREE.md`, wild vines — `docs/WILD_VINE.md`; chunk load registers **vines** (column pass) and **mycelium anchors** (BE scan) into the same reproduce registry; player changelog — `docs/CHANGELOG.md`; config reference — `docs/CONFIGURATION.md`;
...
- Tests: `tests/WildFarming.Tests.csproj` (xUnit, 493 tests).
