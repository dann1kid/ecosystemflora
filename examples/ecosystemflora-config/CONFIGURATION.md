...
**Template:** [`ecosystemflora.example.json`](ecosystemflora.example.json) in this folder (also shipped as `assets/ecosystemflora/ecosystemflora.example.json` in the mod).  
...
For release history see [CHANGELOG.md](https://github.com/dann1kid/vs-wildfarming/blob/main/docs/CHANGELOG.md). This file lists the **complete current JSON key set**; version history is in the changelog.
