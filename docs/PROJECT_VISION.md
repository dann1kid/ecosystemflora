...
- **Баланс** — не только таблицы; пресеты конфига и playtest-цикл.
- **Tallgrass** — следующий слой экосистемы (матрица луга под цветами).
- **Дроп `drygrass` с цветов ножом** — следующая отдельная фича в стиле ванильных патчей (см. roadmap).
