...
**Текущая стадия:** `Ecosystem v3.1.7` — сбор луга (рука → блок, нож/коса → drygrass); плюс aquatic mat 3.1.3–6, soil succession 3.1.2, JSON-участники 3.1.  
**Версия мода:** `3.1.7` · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** 106 (xUnit)  
**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-05-28 (код под modinfo **3.1.7**).
...
## Текущая модель (Ecosystem v3.1.7)
