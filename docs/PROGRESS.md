...
**Версия мода (ModDB):** `4.7.0` · **В коде (unreleased):** `4.11.20` — potato-PC perf + setup wizard · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** xUnit (**882+**)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-07-21 (код **4.11.20**, [`CHANGELOG.md`](CHANGELOG.md)).
...
## Текущая модель (Ecosystem v3.9.24)
...
| **next** | Floral Zones **Cape + Cosmopolitan** (211 entries, 7/7 regions) — committed, not released |
...
| **v4.7 third-party** | Wildcraft / Floral Zones runtime bootstrap; fruitvine climate-only; playtest в мире с модами | [x] код; [ ] playtest |
| **v3.1.x polish** | de handbook; dominant UX; Floral Zones trees; crowfoot worker frontier gate | [ ] [GAPS.md](GAPS.md) |
