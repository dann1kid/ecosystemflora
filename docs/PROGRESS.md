...
**Версия мода (ModDB):** `4.7.0` · **В коде (unreleased):** `4.10.33` — setup wizard welcome + Performance bench · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** xUnit (**882+**)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-07-19 (код **4.10.33**, [`CHANGELOG.md`](CHANGELOG.md)).
