...
**Текущая стадия:** `Ecosystem v3.0` — клонирование **traits** ягодных кустов 1.22 при spread (`CloneBerryTraits`, `BerrySpreadTraitCloner`), опционально off для старого поведения.  
**Версия мода:** `3.0.0` · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** 64 (xUnit)  
**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-05-27 (код под modinfo **3.0.0**).
...
Mod DB — **опубликовано** 2026-05-26. Серия **v2.11.x** (осмотр экологии, скан чанка, локализация); **`v3.0`** — traits ягод при spread; следующий акцент **v3.1**.
