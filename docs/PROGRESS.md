...
**Текущая стадия:** `Ecosystem v3.1.8` — legacy BE migration + fix inspect (I); плюс meadow harvest 3.1.7, aquatic mat 3.1.3–6, soil succession 3.1.2.  
**Версия мода:** `3.1.8` · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** 106 (xUnit)  
**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-05-29 (код под modinfo **3.1.8**).
...
## Текущая модель (Ecosystem v3.1.8)
...
| 5 | **Unit-тесты** — чистые функции (scoring, classification, season, mat spread, hand harvest) | [x] 106 tests |
