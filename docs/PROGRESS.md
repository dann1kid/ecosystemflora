...
### «Перчинка» — обратная связь и смысл (позже)

Не обязательно новые виды; слой **ощущения живого луга**:

- [ ] Сукцессия / два яруса: трава → цветы (после tallgrass)
- [ ] Связь с действиями игрока: выкос/топтание/очистка и pressure (опционально, v2)
- [ ] Видимая обратная связь: handbook или краткая подсказка по биому (dominant species)
- [ ] Редкие виды как награда за стабильный климат (медленный spread, не colonizer)
