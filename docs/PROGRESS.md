...
**Текущая стадия:** `Ecosystem v3.9.7` — spread maturation (colonizer flowers + tallgrass veryshort); Phase 6 simulation engine (chunk-fair spread, event wake, two-phase placement); prior **3.7.x** tree fern / canopy / wild vines.  
**Версия мода:** `3.9.7` · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** xUnit (**395**)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-06-21 (код **3.9.7**, flower + tallgrass spread maturation, [`CHANGELOG.md`](CHANGELOG.md)).
...
## Текущая модель (Ecosystem v3.9.7)
...
| Группа | Блоки |
|--------|--------|
| **Цветы** | `game:flower-*` (20 видов) + `flower-lupine-*` | Colonizers: spread → juvenile block → mature (v3.9.6 — [`FLOWER_SPREAD_MATURATION.md`](FLOWER_SPREAD_MATURATION.md)) |
...
| **3.9.6** | **Flower spread maturation** — colonizers spread juvenile blocks → mature; post-spawn cooldown; [`FLOWER_SPREAD_MATURATION.md`](FLOWER_SPREAD_MATURATION.md) |
