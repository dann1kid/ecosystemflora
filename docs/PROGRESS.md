...
**Версия мода:** `2.6.0` · **Игра:** Vintage Story 1.21+ · **Сборка:** .NET 10  
...
| `EnableTrampling` / `TramplingRadius` / `TramplingStressThreshold` | Протаптывание: растения гибнут рядом с часто ходящими игроками |
| `TramplingSoilDegradation` | Деградация почвы на протоптанных тропах |
