...
**Текущая стадия:** `Ecosystem v3.1.11` — tree spread ice/snow fix; плюс meadow harvest 3.1.10, spread/debris 3.1.9, legacy BE 3.1.8.  
**Версия мода:** `3.1.11` · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** 129 (xUnit)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-05-30 (код под modinfo **3.1.11**).
...
## Текущая модель (Ecosystem v3.1.11)
...
| 5 | **Unit-тесты** — чистые функции (scoring, classification, season, mat spread, hand harvest) | [x] 129 tests |
