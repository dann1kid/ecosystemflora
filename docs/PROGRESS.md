...
**Версия мода:** `3.1.12` · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** 163 (xUnit)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-06-13 (код **3.1.12**, config auto-merge).
...
| 5 | **Unit-тесты** — чистые функции (scoring, classification, season, mat spread, hand harvest, mycelium, config merge) | [x] 163 tests |
