...
**Версия мода (ModDB):** `4.7.0` · **В коде (unreleased):** Cape + Cosmopolitan Floral Zones (`54075a7`) · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** xUnit (**882**)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-07-09 (код **4.7.0** + unreleased Floral Zones 7/7, [`CHANGELOG.md`](CHANGELOG.md)).
