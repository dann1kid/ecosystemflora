...
**Текущая стадия:** `Ecosystem v3.8-dev` — Phase 6 simulation engine: chunk-fair spread + event wake (см. [`PHASE6_SIMULATION.md`](PHASE6_SIMULATION.md)); prior **3.7.1** extended vanilla flora; **3.7.0** tree fern / canopy / wild vines.  
**Версия мода:** `3.8-dev` · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** xUnit (**308**)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-06-14 (код **3.8-dev**, Phase 6.1/6.3, [`CHANGELOG.md`](CHANGELOG.md)).
...
| 5 | **Unit-тесты** — чистые функции (scoring, classification, season, mat spread, hand harvest, mycelium, canopy, tree growth/senescence, ferntree, vines, config merge) | [x] 279 tests |
...
- [ ] **6.6 Season coarse wake** — handbook + tuning docs
