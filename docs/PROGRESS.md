...
**Версия мода:** `2.5.0` · **Игра:** Vintage Story 1.21+ · **Сборка:** .NET 10  
...
| *(pending)* | Tech debt: split BlockFluidHelper → ReedColumnHelper + WaterColumnHelper; xUnit tests (46); docs/modinfo 2.5.0 |
