...
**Текущая стадия:** `Ecosystem v4.5.0` — species CSV registry (ecology + season); spread scale 4.4.1; berry colonies (4.3).  
**Версия мода:** `4.5.0` · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** xUnit (**681**)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-06-26 (код **4.5.0**, species CSV registry, [`SPECIES_ECOLOGY_CSV.md`](SPECIES_ECOLOGY_CSV.md), [`CHANGELOG.md`](CHANGELOG.md)).
