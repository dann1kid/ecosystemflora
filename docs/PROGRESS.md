...
**Текущая стадия:** `Ecosystem v3.7.0` — tree fern ecology, canopy sticks + age branches, wild vine spread (см. [`FERNTREE.md`](FERNTREE.md), [`CANOPY_PHENOLOGY.md`](CANOPY_PHENOLOGY.md), [`WILD_VINE.md`](WILD_VINE.md)); prior **3.6.0** wild tree maturation + phased senescence ([`TREE_AGING.md`](TREE_AGING.md)); **3.5.0** canopy ambience; **3.2.0** seasonal canopy.  
**Версия мода:** `3.7.0` · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** xUnit (**279**)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-06-14 (код **3.7.0**, ferntree + canopy sticks + wild vines, [`CHANGELOG.md`](CHANGELOG.md)).
