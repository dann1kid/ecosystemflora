...
**Версия мода (ModDB):** `4.7.0` · **В коде (unreleased):** `4.8.2` — ecological trails + Floral Zones Cape/Cosmopolitan · **Игра:** Vintage Story 1.22+ · **Сборка:** .NET 10 · **Тесты:** xUnit (**882+**)  

**ModDB:** https://mods.vintagestory.at/ecosystemflora  

Последнее обновление документации: 2026-07-15 (код **4.8.2**, [`CHANGELOG.md`](CHANGELOG.md)).
